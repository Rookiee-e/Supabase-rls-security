...
This guide is opinionated, defensive, and battle-tested.
It prioritizes correctness and security over convenience.

Contributions that weaken guarantees will be rejected.
